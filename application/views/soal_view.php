    <div class="container">
        <h3>List Soal</h3>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Package Question</button>
...
function edit_person(id_paket)
{
    ...
    $.ajax({
        url : "<?php echo site_url('soal/ajax_edit/')?>/" + id_paket,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="nama_soal"]').val(data.nama_soal);
            $('[name="tahun_soal"]').val(data.tahun_soal);
            ...
            <div class="modal-body form">
                <form action="#" id="form" method="post" class="form-horizontal">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-9">
                                <input name="nama_soal" placeholder="Mata Pelajaran" class="form-control" type="text">
                            ...
                            <div class="col-md-9">
                                <input name="tahun_soal" placeholder="Tahun" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="waktu" placeholder="Waktu (Menit)" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        </div>
